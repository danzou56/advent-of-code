...
//                    .filter { path.count { it.name == neighbor.name } > 1 || it.name in listOf("start", "end") }
    ...
    fun testExample() {
      ...
      Assertions.assertEquals(10, part1(input))
      Assertions.assertEquals(36, part2(input))
    }
    ...
    fun testLargeExample() {
      ...
      Assertions.assertEquals(19, part1(input))
      Assertions.assertEquals(103, part2(input))
    }
    ...
    fun testLargerExample() {
      ...
      Assertions.assertEquals(226, part1(input))
      Assertions.assertEquals(3509, part2(input))
    }
